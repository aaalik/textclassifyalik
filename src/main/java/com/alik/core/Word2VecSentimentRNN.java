...
public class Word2VecSentimentRNN {
    ...
    public static void main(String[] args) throws Exception {
        ...
        File firstPositiveReviewFile = new File(FilenameUtils.concat(DATA_PATH, "testing-surat/sandwich/sandwich.txt"));
        ...
        for( int i=0; i<labels.size(); i++ ){
            System.out.println("P(" + labels.get(i) + ") = " + probabilitiesAtLastWord.getDouble(i));
        }
//        System.out.println("\n\n-------------------------------");
//        System.out.println("First positive review: \n" + firstPositiveReview);
//        System.out.println("\n\nProbabilities at last time step:");
//        System.out.println("p(sandwich): " + probabilitiesAtLastWord.getDouble(0));
//        System.out.println("p(surat-izin): " + probabilitiesAtLastWord.getDouble(1));
//        System.out.println("p(surat-kuasa): " + probabilitiesAtLastWord.getDouble(2));
